...
let capabilities = $.ajax(ajax_url, {
  ...
  success: function () {
    let x = capabilities.responseText
      ...
      .split(
        'HS-9b6a7f2197ec403895bacebdca4d0074:south_america-peru-geoglows-drainage_line'
      )[1]
...
function createVolumeTable(
  ...
  $.ajax({
    ...
    success: function (resp) {
      ...
      console.log('createVolumeTable out');
    },
      ...
      if (wms_url) {
        ...
        $.ajax({
          ...
          success: function (result) {
            ...
            var startdate = '';
            stationid = result['features'][0]['properties']['id_Estacio'];
            ...
            basin = result['features'][0]['properties']['Cuenca'];
